...
class BookDatabaseHelper(context: Context) : SQLiteOpenHelper(context, "BookDatabase.db", null, 1)
{
    ...
    override fun onCreate(db: SQLiteDatabase)
    {
        ...
        insertTicketNumber(db, "Основы програмирование: путь к успеху. Цитаты великих: ГЛАВНОЕ — НАЧАТЬ!!!)", "25.05.2024")
        insertTicketNumber(db, "Биология беспозвоночных и безмозглых в 4 томах", "25.05.2024")
